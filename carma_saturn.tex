...
polarization of 5% -- makes it suitable as a polarization calibrator,
                 % In addition, an overall net polarization is
                 % expected from Saturn's rings for experiments that
                 % do not resolve the rings (Fig. 3 of Grossman et
                 % al. 1989). Calibration of the polarization
                 % amplitude may require a more detailed modeling of
                 % Saturn's disk+ring system, though other methods can
                 % be used to calibrate the CMB polarization
                 % amplitude, such as calibrating the polarization
                 % amplitude off the measured cross
                 % temperature-polarization anisotropy from WMAP. At a
                 % minimum, Saturn's polarization at millimeter
                 % wavelengths will provide a high precision
                 % calibrator of the polarization position angle of
                 % CMB experiments. In this proposal, we seek to make
                 % a high-precision measurement of Saturn's polarized
                 % emission at millimeter wavelengths with CARMA. 
